...
/obj/item/gun/energy/wiremod_gun
	...
	cell_type = /obj/item/weapon/cell/wiremod_gun
	item_flags = NONE
...
/obj/item/weapon/cell/wiremod_gun
	maxcharge = 100
...
/obj/item/circuit_component/wiremod_gun/proc/handle_chamber(atom/source)
	...
	if(!parent?.cell)
		return
	var/obj/item/weapon/gun/energy/fired_gun = source
	var/totransfer = min(100, parent.cell.charge)
	var/transferred = fired_gun.power_supply.give(totransfer)
