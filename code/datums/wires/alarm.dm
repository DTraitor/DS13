...
#define var_name value/AALARM_WIRE_IDSCAN = 1
#define var_name value/AALARM_WIRE_POWER = 2
#define var_name value/AALARM_WIRE_SYPHON = 4
#define var_name value/AALARM_WIRE_AI_CONTROL = 8
#define var_name value/AALARM_WIRE_AALARM = 16
