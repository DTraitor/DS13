...
#define BORG_WIRE_MAIN_POWER  2 // The power wires do nothing whyyyyyyyyyyyyy
#define BORG_WIRE_LOCKED_DOWN  4
#define BORG_WIRE_AI_CONTROL  8
#define BORG_WIRE_CAMERA  16
