...
#define SHIELDGEN_WIRE_POWER  1			// Cut to disable power input into the generator. Pulse does nothing. Mend to restore.
#define SHIELDGEN_WIRE_HACK  2			// Pulse to hack the generator, enabling hacked modes. Cut to unhack. Mend does nothing.
#define SHIELDGEN_WIRE_CONTROL  4		// Cut to lock most shield controls. Mend to unlock them. Pulse does nothing.
#define SHIELDGEN_WIRE_AICONTROL  8		// Cut to disable AI control. Mend to restore.
#define SHIELDGEN_WIRE_NOTHING  16		// A blank wire that doesn't have any specific function
