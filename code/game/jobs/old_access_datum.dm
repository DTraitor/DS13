...
#define access_security  2 // Brig timers and permabrig
...
#define access_research  7
/datum/access/tox
	id = access_research
	desc = "Research Labs"
	region = ACCESS_REGION_RESEARCH

#define access_research_storage 8
...
#define access_engineering  24
/datum/access/atmospherics
	id = access_engineering
	desc = "Atmospherics"
	region = ACCESS_REGION_ENGINEERING

#define access_service  25
/datum/access/bar
	id = access_service
	desc = "Bar"
	region = ACCESS_REGION_GENERAL
...
#define access_service  28
/datum/access/kitchen
	id = access_service
	desc = "Kitchen"
	region = ACCESS_REGION_GENERAL

#define access_research  29
...
#define access_security  38
/datum/access/lawyer
	id = access_security
	desc = "Internal Affairs"
	region = ACCESS_REGION_COMMAND

#define access_medical  39
...
#define access_cargo  41
/datum/access/qm
	id = access_cargo
	desc = "Quartermaster"
	region = ACCESS_REGION_SUPPLY

#define access_bridge  42
/datum/access/network
	id = access_bridge
	desc = "Primary Network"
	region = ACCESS_REGION_RESEARCH

// #define free_access_id  43
// #define free_access_id  44
...
#define access_engineering  61 // has access to the entire telecomms satellite / machinery
...
#define access_medical  64 // Psychiatrist's office
/datum/access/psychiatrist
	id = access_medical
	desc = "Psychiatrist's Office"
	region = ACCESS_REGION_MEDBAY

#define access_research  65
/datum/access/xenoarch
	id = access_research
	desc = "Xenoarchaeology"
	region = ACCESS_REGION_RESEARCH

#define access_medical  66
